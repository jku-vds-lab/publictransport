...
#Load all gtfs datas 
tirol_stops = pd.read_csv('unziped/20230721-0401_gtfs_vvt_2023/stops.zip', sep=",")
tirol_stop_times = pd.read_csv('unziped/20230721-0401_gtfs_vvt_2023/stop_times.zip', sep=",")
sbg_stops = pd.read_csv('unziped/20230726-0334_gtfs_salzburgverkehr_2023/stops.zip', sep=",")
sbg_stop_times = pd.read_csv('unziped/20230726-0334_gtfs_salzburgverkehr_2023/stop_times.zip', sep=",")
vor_stops = pd.read_csv('unziped/20230718-0451_gtfs_vmobil_2023/stops.zip', sep=",")
vor_stop_times = pd.read_csv('unziped/20230718-0451_gtfs_vmobil_2023/stop_times.zip', sep=",")
zug_stops = pd.read_csv('unziped/20230726-0252_gtfs_evu_2023/stops.zip', sep=",")
zug_stop_times = pd.read_csv('unziped/20230726-0252_gtfs_evu_2023/stop_times.zip', sep=",")
kar_stops = pd.read_csv('unziped/20230726-0230_gtfs_kaerntnerlinien_2023/stops.zip', sep=",")
kar_stop_times = pd.read_csv('unziped/20230726-0230_gtfs_kaerntnerlinien_2023/stop_times.zip', sep=",")
stm_stops = pd.read_csv('unziped/20230726-0321_gtfs_verbundlinie_2023/stops.zip', sep=",")
stm_stop_times = pd.read_csv('unziped/20230726-0321_gtfs_verbundlinie_2023/stop_times.zip', sep=",")
oo_stops = pd.read_csv('unziped/20230721-0303_gtfs_ooevv_2023/stops.zip', sep=",")
oo_stop_times = pd.read_csv('unziped/20230721-0303_gtfs_ooevv_2023/stop_times.zip', sep=",")
ost_stops = pd.read_csv('unziped/20230726-0355_gtfs_vor_2023/stops.zip', sep=",")
ost_stop_times = pd.read_csv('unziped/20230726-0355_gtfs_vor_2023/stop_times.zip', sep=",")
linz_stops = pd.read_csv('unziped/20230719-0451_gtfs_esg_2023/stops.zip', sep=",")
linz_stop_times = pd.read_csv('unziped/20230719-0451_gtfs_esg_2023/stop_times.zip', sep=",")
...
# Replace the values in the stop_headsign column
#stop_times['stop_headsign'] = stop_times['stop_id'].map(stop_id_to_name)
...
#stops["stop_lat"] = stops["stop_lat"].astype('float32') doesn't work but wouldn't be useful after mapping
#stops["stop_lon"] = stops["stop_lon"].astype('float32') doesn't work but wouldn't be useful after mapping
